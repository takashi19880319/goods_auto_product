...
# ログファイルがオープンできなかったらログファイルにエラーを書く
...
sub add_r_itemcsv_name {
	my @csv_r_item_name=("コントロールカラム","商品管理番号（商品URL）","商品番号","全商品ディレクトリID","タグID","PC用キャッチコピー","モバイル用キャッチコピー","商品名","販売価格","表示価格","送料","商品情報レイアウト","PC用商品説明文","モバイル用商品説明文","PC用販売説明文","商品画像URL","在庫タイプ","在庫数","在庫数表示","項目選択肢別在庫用横軸項目名","項目選択肢別在庫用縦軸項目名","在庫あり時納期管理番号","あす楽配送管理番号","再入荷お知らせボタン","ポイント変倍","ポイント変倍率適用期間");
...
##############################
## 楽天用reset_item.csvファイルに項目名を追加
##############################

sub add_r_reset_itemcsv_name {
	my @csv_r_reset_item_name=("コントロールカラム","商品管理番号（商品URL）","商品番号","在庫タイプ","再入荷お知らせタイプ",);
	my $csv_r_reset_item_name_num=@csv_r_reset_item_name;
	my $csv_r_reset_item_name_count=0;
	for my $csv_r_reset_item_name_str (@csv_r_reset_item_name) {
		Encode::from_to( $csv_r_reset_item_name_str, 'utf8', 'shiftjis' );
		$output_item_csv->combine($csv_r_reset_item_name_str) or die $output_item_csv->error_diag();
		my $post_fix_str="";
		if (++$csv_r_reset_item_name_count >= $csv_r_reset_item_name_num) {
			$post_fix_str="\n";
		}
		else {
			$post_fix_str=",";
...
sub add_y_datacsv_name {
	my @csv_y_data_name=("path","name","code","sub-code","original-price","price","sale-price","options","headline","caption","abstract","explanation","additional1","additional2","additional3","relevant-links","ship-weight","taxable","release-date","temporary-point-term","meta-key","meta-desc","template","sale-period-start","sale-period-end","sale-limit","sp-code","brand-code","person-code","yahoo-product-code","product-code","jan","isbn","delivery","product-category","spec1","spec2","spec3","spec4","spec5","display","astk-code");
...
<table width="600" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><a href="http://event.rakuten.co.jp/asuraku/about/" target="_blank"><img src="http://www.rakuten.ne.jp/gold/hff/image/h_banaasuraku3.gif" border="0" alt="あす楽"></a><br><a href="http://www.rakuten.ne.jp/gold/hff/review/review2012.html" target="_blank"><img src="http://image.rakuten.co.jp/hff/cabinet/mail/2013_main.gif" border="0" alt=""></a><br><br></td>
  </tr>
  <tr>
</table>
<table width="600" border="0" cellpadding="0" cellspacing="0">
...
HTML_STR_1_2_2
		...
		my $after_rep_str7="</tr></table><div style='margin-top:3px;text-align:right;'><a href='http://www.rakuten.ne.jp/gold/hff/howto-size' target='_blank'>$size_info<img src='http://www.rakuten.ne.jp/gold/hff/image/window.gif'  /></a></div></td></tr></table>";
...
my $html_str_whc=
<<"HTML_STR_whc";
・キズのように見える白い線や表面の白い粉は、多くが表面に表れた蝋です。<br>
...
<img src="http://www.rakuten.ne.jp/gold/hff/image/spacer.gif" width="600" height="10" alt="" border="0"><br>
<!--商品画像A -->
<center><img src="http://image.rakuten.co.jp/hff/cabinet/
HTML_STR_3_WOMENS
...
HTML_STR_1_WOMENS
	...
	if (index($global_entry_goods_info[1], "WOMEN'S", 0) == -1) {
        ...
        return "$image_url_str"."$global_entry_goods_info[0]"."_1.jpg";
}
...
HTML_STR_1_2_2
		...
		my $after_rep_str6="<td align='center' scope='col' style='border-bottom:1px solid #CCCCCC;border-right:1px solid #CCCCCC;'>";
		$goods_info =~ s/$before_rep_str6/$after_rep_str6/g;
		my $after_rep_str7="</tr></table><div style='margin-top:3px;text-align:right;'><a href='howto-size.html' target='_blank'>$size_info<img src='http://lib.shopping.srv.yimg.jp/lib/hff/window.gif' border='0'  /></a></div></td></tr></table>";
		my $before_rep_str7_1="</table></td></tr></table>";
		$goods_info =~ s/$before_rep_str7_1/$after_rep_str7/g;
		my $before_rep_str7_2=
<<"HTML_STR_7_2";
...
・<a href='howto3.html' target='_blank'>商品在庫についてはこちらをご覧ください。</a></font></td>
</tr>
</table>
HTML_STR_2
        Encode::from_to( $html_str2, 'utf8', 'shiftjis' );
...
sub create_y_options {
	my $options="";
	# あすつく文言の登録
	my $tomorrow_hope_str="あすつく 希望する 希望しない";
